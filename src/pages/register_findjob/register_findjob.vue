    ...
    <div class="flex-col section_2">
      ...
      <div class="flex-col group mt-51">
        <div class="flex-col self-stretch">
          <div class="flex-row items-center section_3">
            <div class="flex-col justify-start items-center text-wrapper">
              <span class="font_3 text_4">Job Wanted</span>
            </div>
            <span class="font_3 text_5 ml-58 text-RyWiNb6d" @click="onClick">Recruitment</span>
          </div>
          ...
          <div class="flex-col justify-start items-center text-wrapper_3 view-X5T8N3bF" @click="onClick_1">
        ...
        <div class="self-center group_2 mt-20">
          ...
          <span class="text_11 text-GlvhnewE" @click="onClick_2"> Go to log in</span>
        </div>
        <div class="flex-row self-stretch group_3 mt-20">
          <van-checkbox class="section_5" v-model="v_model" name="e6bDx7Gn" shape="regtangular"></van-checkbox>
...
<script>
  export default {
    ...
    methods: {
      ...
      onClick() {
        this.$router.push({ name: 'register_recruitment' });
      },
      async onClick_1() {
        // 验证输入
        ...
        console.log('准备发送注册数据:', { phone: this.phone, password: this.password,type:"user"});
        // 验证通过后发送请求
        this.$axios({
        url: '/register',     
        method: 'post',
